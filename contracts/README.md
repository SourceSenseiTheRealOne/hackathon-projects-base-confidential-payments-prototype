...
Preflight reads only. Optional BASE_SEPOLIA_RPC_URL selects an endpoint but chain ID must be 84532. It resolves the USDC wrapper, beacon implementation and executor. BASE_PAYMENTS_TESTNET_PRIVATE_KEY is checked only for presence; no signing or transaction submission exists in this script.
